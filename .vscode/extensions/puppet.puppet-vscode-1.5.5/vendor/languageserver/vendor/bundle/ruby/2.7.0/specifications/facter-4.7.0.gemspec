...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_development_dependency(%q<ffi>.freeze, ["= 1.15.5"])
    ...
    s.add_dependency(%q<sys-filesystem>.freeze, ["~> 1.4"])
    s.add_dependency(%q<webmock>.freeze, ["~> 3.12"])
    s.add_dependency(%q<yard>.freeze, ["~> 0.9"])
    s.add_dependency(%q<hocon>.freeze, ["~> 1.3"])
    s.add_dependency(%q<thor>.freeze, [">= 1.0.1", "< 1.3"])
  end
end
