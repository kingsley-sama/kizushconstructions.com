...
class ConnectionHandler {
    ...
    constructor(context, statusBar, logger, config, puppetLangID, puppetFileLangID) {
        ...
        this.puppetFileLangID = puppetFileLangID;
        ...
        this._languageClient = new node_1.LanguageClient('PuppetVSCode', serverOptions, clientOptions);
        this._languageClient
            ...
            telemetry_1.reporter.sendTelemetryErrorEvent(reason);
        })
            .catch((reason) => {
        ...
        this.context.subscriptions.push(vscode.commands.registerCommand(messages_1.PuppetCommandStrings.puppetShowConnectionLogsCommandId, () => {
            this.logger.show();
        }));
    }
    start() {
