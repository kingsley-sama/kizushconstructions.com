...
const sections = [
  {
    ...
    image:
      "/images/im3rd-media-FJZtZldA-uE-unsplash.jpg",
...
function Section({ data, imageOnLeft = false }) {
  const clipPath = imageOnLeft ? "polygon(0 0, 100% 10%, 100% 90%, 0 100%)" : "polygon(0 10%, 100% 0, 100% 100%, 0 90%)"
  ...
  return (
    <div className="container mx-auto bg-white">
      {sections.map((section, index) => (
        <div key={section.id} className="py-2 md:py-4">
          <Section data={section} imageOnLeft={index % 2 === 0} />
